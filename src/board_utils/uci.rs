        ...
        if let Some(piece) = from_square.get_piece() {
            ...
            if let Piece::Pawn(color) = piece {
                let is_promotion = match (color, to_square.coordinate) {
                    ...
                    (Color::White, Coordinate::A(7) | Coordinate::B(7) | Coordinate::C(7) | 
                                 Coordinate::D(7) | Coordinate::E(7) | Coordinate::F(7) | 
                                 Coordinate::G(7) | Coordinate::H(7)) => true,
                    // Pion noir atteignant la 1ère rangée
                    (Color::Black, Coordinate::A(0) | Coordinate::B(0) | Coordinate::C(0) | 
                                 Coordinate::D(0) | Coordinate::E(0) | Coordinate::F(0) | 
                                 Coordinate::G(0) | Coordinate::H(0)) => true,
                    _ => false
                };
                    ...
                    if let Some(_target_square) = self.get_square(move_square.coordinate) {
                        ...
                        if let Piece::Pawn(_) = piece {
                            ...
                            let is_promotion = match move_square.coordinate {
                                Coordinate::A(7) | Coordinate::B(7) | Coordinate::C(7) | Coordinate::D(7) |
                                Coordinate::E(7) | Coordinate::F(7) | Coordinate::G(7) | Coordinate::H(7) => piece.color() == Color::White,
                                Coordinate::A(0) | Coordinate::B(0) | Coordinate::C(0) | Coordinate::D(0) |
                                Coordinate::E(0) | Coordinate::F(0) | Coordinate::G(0) | Coordinate::H(0) => piece.color() == Color::Black,
                                _ => false,
                            };
                            ...
                            if is_promotion {
                                ...
                                if let Some(promoted_piece) = move_square.get_piece() {
                                    ...
                                    uci_moves.push(format!("{}{}{}", from_uci, to_uci, promotion_char));
                                } else {
